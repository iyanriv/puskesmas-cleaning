...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="mb-0 fw-bold">Ubah Barang</h3>
            <p class="text-muted mb-0" style="font-size:0.85rem;">
                Jika stok bertambah, selisihnya otomatis dicatat ke Laporan Stok bulan berjalan.
            </p>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control rounded-start-3 @error('kode_barang') is-invalid @enderror"
                                   name="kode_barang" id="inputKodeBarang"
                        ...
                        @if($barang->produkKebersihan)
                            <div class="text-success fw-semibold mt-1" style="font-size:0.8rem;" id="infoNamaProduk">
                                ✓ Terhubung ke: {{ $barang->produkKebersihan->nama_barang }}
                            </div>
                        @else
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control rounded-3 @error('satuan') is-invalid @enderror"
                               name="satuan" id="inputSatuan" value="{{ old('satuan', $barang->satuan) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control rounded-3 @error('stok_saat_ini') is-invalid @enderror"
                               name="stok_saat_ini" value="{{ old('stok_saat_ini', $barang->stok_saat_ini) }}"
                               min="0" required>
                        @error('stok_saat_ini') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div class="form-text text-success">
                            <i class="bi bi-info-circle"></i>
                            Jika stok bertambah dari {{ $barang->stok_saat_ini }}, selisihnya dicatat ke laporan stok.
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control rounded-3 @error('stok_minimum') is-invalid @enderror"
                               name="stok_minimum" value="{{ old('stok_minimum', $barang->stok_minimum) }}" min="0">
                        @error('stok_minimum') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    {{-- Foto --}}
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Foto Barang (kosongkan jika tidak ingin mengubah)</label>
                        ...
                        @if($barang->foto_barang)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $barang->foto_barang) }}"
                                     alt="Foto Barang" width="80" class="img-thumbnail rounded-3">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control rounded-3 @error('deskripsi') is-invalid @enderror"
                                  name="deskripsi" rows="3">{{ old('deskripsi', $barang->deskripsi) }}</textarea>
